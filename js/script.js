...
socket.on('NewQuestion', question =>{
    ...
    changeQuestion(question.ques, question.antwort1, question.antwort2, question.antwort3, question.antwort4);
...
function showNewQuestion(show){
    if(show){
        ÜberschriftFrage.innerHTML ="Bitte beantworten Sie die Frage!"
...
function markSelectedAnswer(radioValueSelected){
    ...
    ÜberschriftFrage.innerHTML ="Bald können Sie eine neue Frage beantworten!"
    Frageausgewählt.innerHTML ="Gerade hatten Sie die Blau Markierte Antwort ausgewählt"
...
btnAnswerQuestion.addEventListener("click", function(){
    ...
    if(radioValue == undefined){
        window.alert("Bitte Wählen Sie eine Antwortmöglichkeit aus!")
    }
    else{
